\begin{table}[htbp]
    \centering
    \caption{Hiperparâmetros selecionados por \textit{RandomizedSearchCV} (30 candidatos) com \textit{TimeSeriesSplit} (5 \textit{folds}) e AUC-ROC como critério de seleção.}
